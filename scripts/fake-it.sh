...
time $SU nvidia-docker run --rm -v $(pwd):/images albarji/neural-style -backend cudnn -cudnn_autotune -normalize_gradients -init image -content_weight 100 -style_weight 1500 -content_image contents/$1 -style_image styles/$2 -output_image $output_name -image_size $3
